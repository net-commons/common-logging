...
rem tools\nant\bin\nant.exe -f:Common.Logging.build build package-zip package-nuget -D:project.sign=true -D:package.version=4.0 -D:nuget.version.suffix=Alpha1 -D:project.releasetype=release > buildlog.txt
