...
namespace Common.Logger.NLog
{
    ...
    public class NLogLoggerFactoryAdapterVariablesContextTests
    {
        ...
        public void CheckThreadVariablesSet()
        {
            ...
            var actualValue = global::NLog.MappedDiagnosticsLogicalContext.Get("TestKey");
	    ...
	    public void CheckNestedThreadVariablesSet()
	    {
		    ...
		    int depth = global::NLog.NestedDiagnosticsLogicalContext.GetAllMessages().Length;
		    ...
		    depth = global::NLog.NestedDiagnosticsLogicalContext.GetAllMessages().Length;
